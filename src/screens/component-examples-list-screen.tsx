...
const componentExamples: Array<{ label: string; params: NavigatorScreenParams<ComponentExamplesNavigatorParams> }> = [
    ...
    { label: "Navigation Button Field", params: { screen: "NavigationButtonFieldExampleScreen" } },
    { label: "News List Item", params: { screen: "NewsListItemExampleScreen" } },
    ...
    { label: "Species Statistics Report Item", params: { screen: "SpeciesStatisticsReportItemExampleScreen" } },
    { label: "Spinner", params: { screen: "SpinnerExampleScreen" } },
    { label: "Statistics Hunt Info Card", params: { screen: "StatisticsHuntInfoCardExampleScreen" } },
    { label: "Square Icon Button", params: { screen: "SquareIconButtonExampleScreen" } },
    { label: "Statistics Summary Row", params: { screen: "StatisticsSummaryRowExampleScreen" } },
