...
type IndividualHuntStatisticsScreenLoadedProps = {
    statistics: IndividualHuntStatisticsItem[];
};

export function IndividualHuntStatisticsScreenLoaded(props: IndividualHuntStatisticsScreenLoadedProps) {
