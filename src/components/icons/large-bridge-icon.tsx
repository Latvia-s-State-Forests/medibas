...
type LargeBridgeIconProps = {
    width?: number;
    height?: number;
    color?: Color;
};

export function LargeBridgeIcon({ width = 32, height = 32, color = "gray8" }: LargeBridgeIconProps) {
