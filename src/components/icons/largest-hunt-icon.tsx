...
type LargestHuntIconProps = {
    width?: number;
    height?: number;
    color?: Color;
};

export function LargestHuntIcon({ width = 96, height = 96, color = "gray4" }: LargestHuntIconProps) {
