...
type LargeWaterIconProps = {
    width?: number;
    height?: number;
    color?: Color;
};

export function LargeWaterIcon({ width = 32, height = 32, color = "gray8" }: LargeWaterIconProps) {
