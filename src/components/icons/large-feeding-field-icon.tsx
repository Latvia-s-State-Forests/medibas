...
type LargeFeedingFieldIconProps = {
    width?: number;
    height?: number;
    color?: Color;
};

export function LargeFeedingFieldIcon({ width = 32, height = 32, color = "gray8" }: LargeFeedingFieldIconProps) {
