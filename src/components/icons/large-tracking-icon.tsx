...
type LargeTrackingIconProps = {
    width?: number;
    height?: number;
    color?: Color;
};

export function LargeTrackingIcon({ width = 32, height = 32, color = "gray8" }: LargeTrackingIconProps) {
